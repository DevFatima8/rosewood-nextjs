...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Contact rosewood HOTEL Islamabad or Karachi for room reservations, availability and guest assistance. Call 0311 6731810 (Islamabad) or 0370 6466550 (Karachi).",
};

const faqs = [
  ["How can I confirm room availability?", "Call or WhatsApp us on 0311 6731810 (Islamabad) or 0370 6466550 (Karachi), or submit the inquiry form with your preferred branch and dates. Our team will confirm current availability directly."],
  ["Can I contact both branches on the same number?", "No. Each branch has its own contact number. For Islamabad, call 0311 6731810. For Karachi, call 0370 6466550. Please mention your preferred city when contacting us."],
